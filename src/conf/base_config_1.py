...
def get_default_conf():
    ...
    cfg.train = dict()
    cfg.train.folder = 'stage_2_train_images_256_png/'
    ...
    cfg.test = dict()
    cfg.test.folder = 'stage_2_test_images_256_png/'
    ...
    # example for dcm loader with sigmoid brain, subdural and bone window
    #cfg.use_png = False
    #cfg.window_conf = [[-1, -1], [80, 200], [600, 2800]]
    #cfg.window_type = 1  # 0 - normal, 1 - sigmoid
    #cfg.train.folder = 'stage_1_train_images/'
    #cfg.train.path = cfg.path + cfg.train.folder
